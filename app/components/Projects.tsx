...
import { ArrowRight, Bot, AudioWaveform, FileText, BrainCircuit } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, idx) => (
            <motion.div
              ...
              className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-lg p-8 overflow-hidden transition-all duration-300 hover:border-white/20 hover:shadow-[0_0_40px_rgba(255,255,255,0.05)] cursor-pointer"
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="mb-6 p-3 bg-white/10 rounded-xl inline-flex self-start border border-white/5">
                  {project.icon}
                </div>
